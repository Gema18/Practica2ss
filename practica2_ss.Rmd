...
```{r}
# Cargamos los datos en la variable ecg

ecg <- readMat("./ecg.mat")$ecg

# definimos la función electro
...
# comprobamos cómo es el electrocardiograma cuando le ponemos un alpha de 0.3 para ver como es.
...
# electro_filtro <- function(ecg, alpha){
#   bn1 = 0
#   en1 = 0
#   blf = c()
#   for (i in 1:length(ecg)) {
#     b <- ecg[i] - en1 + alpha * bn1
#     bn1 = b
#     en1 = ecg[i]
#     blf = append(blf,b)
#   }
...
# ecg = 
# alpha =1
# elec_fil = electro_filtro(ecg,alpha)
```
