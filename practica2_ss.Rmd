...
Ahora queremos darle valores diferentes a la variable alpha para comparar los resutlados, en ete caso pondremos ambos extremos: 0 y 1.

```{r}
alpha = 0
bl_0 = electro(ecg, alpha)

alpha = 1
bl_1 = electro(ecg, alpha)
